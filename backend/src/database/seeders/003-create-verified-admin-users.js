...
/**
 * VERIFIED CLEAN SEEDER - Uses single 'name' field
 * 
 * Perfect alignment with User model and migration
 */
...
module.exports = {
  up: async (queryInterface, Sequelize) => {
    ...
    // ✅ VERIFIED: Using single 'name' field (matches model and migration)
